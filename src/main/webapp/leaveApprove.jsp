			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="card">
						...
						<form action="${pageContext.request.contextPath}/getStaffClocklnState" method="post">
							<div class="card-body">
								<table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
									<thead>
									<tr role="row">
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">请假人</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">请假类型</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">请假说明</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">请假时间</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">状态</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">下载图片</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
									...
									<c:forEach items="${list}" var="li">
										<tr role="row" class="odd">
											...
											<td>${li.state}</td>
											<td>
												<a href="${pageContext.request.contextPath}/download?path=${li.imgPath}"><button type="button"  class="btn btn-warning btn-sm">下载</button></a>
											</td>
											<td>
												<a href="${pageContext.request.contextPath}/updateState/?id=${li.id}&state=通过"><button type="button"  class="btn btn-warning btn-sm">通过</button></a>
												<a href="${pageContext.request.contextPath}/updateState/?id=${li.id}&state=拒绝"><button type="button"  class="btn btn-warning btn-sm">拒绝</button></a>
											</td>
										</tr>
									</c:forEach>
									</tbody>
