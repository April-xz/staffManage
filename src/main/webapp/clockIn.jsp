				...
				<section class="content">
					<div class="card">
						...
						<form action="${pageContext.request.contextPath}/getStaffClocklnState" method="post">
							...
							<div class="card-footer">
								<button type="button" onclick="clockln()" class="btn btn-primary">打卡</button>
								<button type="submit" class="btn btn-primary">查询记录</button>
							</div>
						</form>
								...
								<table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
									...
									<tr role="row">
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">评优等级</th>
										<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Rendering engine: activate to sort column descending">出勤率</th>
									</tr>
									</thead>
									<tbody>
										<tr role="row" class="odd">
											<td class="sorting_1">${rate}</td>
											<td class="sorting_1">${rate1}%</td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<div class="jsgrid-grid-header jsgrid-header-scrollbar">
									<table class="jsgrid-table">
										<tr class="jsgrid-header-row">
											<th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">时间</th>
											<th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">状态</th>
										</tr>
									...
									<table class="jsgrid-table">
										<tbody>
											<c:forEach items="${list}" var="s">
												<tr class="jsgrid-row">
													<td class="jsgrid-cell" style="width: 150px;">${s.time}</td>
													<td class="jsgrid-cell" style="width: 150px;">${s.state}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
