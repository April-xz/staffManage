							...
							<div class="col-md-12">
								<div class="card card-info">
									<div class="card-header">
										<h3 class="card-title">部门信息修改</h3>
									</div>
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/StaffManageController/updateDepartmentInfo" method="post">
										<div class="card-body">
											<div class="form-group row">
												<label for="" class="col-sm-1 col-form-label">部门编号</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="departmentId" value="${map.departmentId}" readonly="readonly" placeholder="部门编号">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">部门名称</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="departmentName" value="${map.departmentName}" id="inputPassword3" placeholder="部门名称">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">部门职责</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="departmentActiv" value="${map.departmentActiv}" id="inputPassword3" placeholder="部门职责">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">部门人数</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="departmentPer" value="${map.departmentPer}" id="" placeholder="部门人数">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">部门领导</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="departmentLeader" value="${map.departmentLeader}" placeholder="部门领导">
												</div>
											</div>
										</div>
										<!-- /.card-body -->
