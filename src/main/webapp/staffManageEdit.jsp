							...
							<div class="col-md-12">
								<div class="card card-info">
									<div class="card-header">
										<h3 class="card-title">员工档案修改</h3>
									</div>
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/StaffManageController/updateStaffInfo">
										<div class="card-body">
											<div class="form-group row">
												<label for="inputEmail3" class="col-sm-1 col-form-label">员工编号</label>
												<div class="col-sm-6">
													<input type="text" name="id" value="${map.id}" class="form-control" readonly="readonly" id="inputEmail3" placeholder="员工编号">
												</div>
											</div>
											<div class="form-group row">
