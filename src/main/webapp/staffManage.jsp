											...
											<div class="row">
												<div class="col-sm-12">
													<div class="card-footer">
														<a href="${pageContext.request.contextPath}/StaffManageController/getDepartmentAndJump"><button type="submit" class="btn btn-primary">增加员工</button>		</a>
													</div>
													<table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
														<thead>
															<tr role="row">
																<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending"
																 aria-label="Rendering engine: activate to sort column descending">员工编号</th>
																...
																<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">员工年龄</th>
																<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">员工性别</th>
														...
														<c:forEach items="${list}" var="li">
															<tr role="row" class="odd">
																...
																<td>${li.department}</td>
																<td>
																	<a href="${pageContext.request.contextPath}/StaffManageController/getStaffInfoById?id=${li.id}"><button type="button"  class="btn btn-warning btn-sm">修改</button></a>
																	<a href="${pageContext.request.contextPath}/StaffManageController/deleteStaffInfo?id=${li.id}"><button type="button"  class="btn btn-warning btn-sm">删除</button></a>
																</td>
															</tr>
														</c:forEach>
														</tbody>
