							...
							<div class="col-md-12">
								<div class="card card-info">
									<div class="card-header">
										<h3 class="card-title">部门信息添加</h3>
									</div>
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/StaffManageController/addDepartmentInfo" method="post">
										<div class="card-body">
											<div class="form-group row">
												<label for="" class="col-sm-1 col-form-label">部门编号</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="departmentId" value="${map.departmentId}"  placeholder="部门编号">
												</div>
											</div>
											<div class="form-group row">
